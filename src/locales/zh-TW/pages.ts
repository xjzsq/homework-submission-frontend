export default {
  'pages.404.subTitle': '為什麼會變成這樣子呢？',
  'pages.404.backHome': '返回主頁',
  'pages.layouts.userLayout.title': '希望不是最差的作業提交體驗', //'希望打造最舒適的作業提交體驗',
  'pages.login.passwordLogin.tab': '賬戶密碼登錄',
  'pages.login.passwordLogin.errorMessage': '錯誤的用戶名和密碼',
  ...
  'pages.login.authLogin.tab': '驗證器登錄',
  'pages.login.authLogin.errorMessage': '錯誤的用戶名或代碼（或已過期）',
  'pages.login.token.placeholder': '一次性密碼代碼',
  'pages.login.token.required': '一次性密碼代碼是必填項！',
  'pages.login.rememberMe': '自動登錄',
  'pages.login.forgotPassword': '忘記密碼 ?',
  'pages.login.submit': '登錄',
  'pages.login.loginWith': '其他登錄方式 :',
  'pages.login.registerAccount': '註冊',
  'pages.welcome.introduction': '使用說明',
  'pages.welcome.link': '歡迎使用',
  'pages.welcome.advancedLayout': '高級布局',
  'pages.welcome.alertMessage': '如果發現有任何不對勁，那應該就是bug了，請大膽聯繫開發者。',
  ...
  'pages.homeworklist.name': '作業名稱',
  'pages.homeworklist.modal.title': '作業概覽',
